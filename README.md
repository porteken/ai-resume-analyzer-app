...
A web application hosted [here](https://ai-resume-analyzer-app.pages.dev/) that analyzes resumes against job descriptions using Google's Gemini 3 Flash AI model and returns insights on candidate fit, strengths, gaps, and recommendations.
